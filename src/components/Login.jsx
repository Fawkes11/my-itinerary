...
const Login = () => {
  return (
    <div className="container mx-auto max-w-md shadow py-12 px-8 rounded-lg font-sans">
      ...
      <form className="max-w-md mx-auto mt-6 p-">
        <div className="mb-4">
          ...
          <input
            ...
            name="email"
            id="email"
            className="w-full mt-1 px-4 py-2 border rounded-lg focus:ring-blue-600 focus:border-blue-600"
        ...
        <div className="mb-4">
          ...
          <input
            ...
            name="password"
            id="password"
            className="w-full mt-1 px-4 py-2 border rounded-lg focus:ring-primary-600 focus:border-primary-600"
            placeholder="••••••••"
            required
          />
        </div>
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="#" className="text-blue-600 dark:text-blue-500 font-medium">
            Forgot password?
          </a>
        </div>
        <button
          type="submit"
          className="w-full button-blue  focus:ring-blue-800 text-white py-2 rounded-lg"
        >
